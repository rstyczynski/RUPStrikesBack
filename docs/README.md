...
will create templates for you.
    ...
    How to proceed - all instructions, rules, etc. are taken from RUPStrikesBack. Add RUPStrikesBack `https://github.com/rstyczynski/RUPStrikesBack.git` branch `feature/version-2.0-sprint-backlog-management` as a submodule, refresh if needed (git submodule update --remote), and copy AGENTS.md, HUMANS.md and RUP_patch.md from RUPStrikesBack to root of this repository. Then run `@RUPStrikesBack/.claude/commands/rup-manager.md`.
